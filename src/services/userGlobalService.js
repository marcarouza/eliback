...
async function checkUser() {
	try {
		...
		if (data && data.user) {
			...
			console.log(
				'🚀 ~ userGlobalService.js:40 ~ checkUser ~ userStateGlobal.userID  ==> ',
			...
			console.log(
				'🚀 ~ userGlobalService.js:46 ~ checkUser ~ userStateGlobal.userPseudo  ==> ',
				userStateGlobal.userPseudo
			);

			userStateGlobal.userEmail = data.user.email;
			console.log(
				'🚀 ~ userGlobalService.js:50 ~ checkUser ~ userStateGlobal.userEmail  ==> ',
				userStateGlobal.userEmail
			);

			userStateGlobal.isLoggedIn = true;

			console.log(
				'🚀 ~ userGlobalService.js:52 ~ checkUser ~ userStateGlobal.isLoggedIn  ==> ',
				userStateGlobal.isLoggedIn
			);
			console.log(
				'🚀 ------------------------------------------------------------------------------------------------------🚀'
			);
