		...
		<div class="container">
			...
			<ul class="navbar-nav">
				<li
					...
					:key="item.id"
				>
					<!-- Utilisation de router-link pour les liens normaux -->
					<router-link
					...
					<!-- Pour le lien spécial Blog qui intervient avec un click personnalisé -->
					<a
...
export default {
      ...
      return {
         ...
         isLoggedIn: false,
			...
			navItems: [
				...
				{
					id: 4,
					type: 'anchor', // type d'élément spécial avec gestion via click
					idAttr: 'blogLink', // ID à appliquer sur l'élément <a>
					activePath: '/homeblogPage',
					icon: 'fas fa-blog',
					title: 'BLOG',
					ariaLabel: 'BLOG',
				},
	...
	methods: {
		navigateToBlog() {
			// Navigation vers la page blog. Vous pouvez, par exemple, utiliser $router.push
			this.$router.push('/homeblogPage');
      },
