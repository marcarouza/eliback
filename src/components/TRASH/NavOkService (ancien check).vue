...
export default {
  name: 'NavService CHECK',
  setup() {
    const { user, userID, userPseudo, isLoggedIn, localUserSession } = userGlobalService;

    console.log('🚀 ---------------------------------------------------🚀')
    console.log('🚀 ~ NavOkService.vue:177 ~ setup ~ user  ==> ', user)
    console.log('🚀 ---------------------------------------------------🚀')
    const router = useRouter();


    // Exemple d'utilisation avec watchEffect
    watchEffect(() => {
